...
- `Data/`: enunciado e base original local.
- `exes/`: executaveis e atalhos de revisao visual.
...
- `results_manual/`: resultados usados na avaliacao visual final.
- `report_latex/`: fonte do relatorio em LaTeX.
...
```bash
./build/lab02_hough_pratos --input-dir Data/sel_data --output-dir results_manual --sweep
```
...
```bash
./build/review_labels --images-dir results_manual/balanced/images --csv results_manual/balanced/classification_template.csv
```
